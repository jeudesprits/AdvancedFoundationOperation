...
class ExclusivityController {
  ...
  func addOperation(_ operation: Operation, categories: [String]) {
    ...
    serialQueue.sync {
      for category in categories {
        self.noqueueAddOperation(operation, category: category)
      }
    }
  }
  ...
  func removeOperation(_ operation: Operation, categories: [String]) {
    serialQueue.async {
      for category in categories {
        self.noqueueRemoveOperation(operation, category: category)
      }
    }
  }
  ...
  private func noqueueAddOperation(_ operation: Operation, category: String) {
  ...
  private func noqueueRemoveOperation(_ operation: Operation, category: String) {
